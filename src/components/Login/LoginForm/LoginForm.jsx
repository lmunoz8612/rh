  ...
  return (
    <Container maxWidth="xs">
      <Box sx={classes.container} className="pd-3">
        ...
        <form
          onSubmit={(e) =>
            props.onSubmit(e, { username, password, rememberMe })
          }
          style={classes.form}
        >
          <FormField
            ...
            error={
              props.error.error && props.error.type === 'username'
                ? true
                : false
            }
            helperText={
              props.error.error &&
              props.error.type === 'username' &&
              props.error.message
            }
          />
          <FormField
            ...
            error={
              props.error.error && props.error.type === 'password'
                ? true
                : false
            }
            helperText={
