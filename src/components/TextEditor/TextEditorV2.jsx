...
const ButtonAlignLeft = createButton(
  'Alinear a la isquierda',
  <i className="ri-align-left"></i>,
  'justifyLeft'
);
const ButtonAlignCenter = createButton(
  'Alinear al centro',
  <i className="ri-align-center"></i>,
  'justifyCenter'
);
const ButtonAlignRight = createButton(
  'Alinear a la derecha',
  <i className="ri-align-right"></i>,
  'justifyRight'
);
const ButtonListBulleted = createButton(
  'Viñetas',
  <i className="ri-list-unordered"></i>,
  'insertUnorderedList'
);
const ButtonListNumbered = createButton(
  'Numeración',
  ...
  return (
    <EditorProvider>
      <Editor
        ...
        value={value}
        onChange={onChange}
        containerProps={{ style: editorContainerProps }}
      >
        <Toolbar>
          <ButtonBold />
          <ButtonItalic />
