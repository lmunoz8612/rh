          ...
          <>
            <TableContainer component={Paper} className="mt-1">
              <Table>
                ...
                <TableBody>
                  {filteredUsers[page - 1] &&
                    filteredUsers[page - 1].map((row, i) => (
                      <TableRow key={row.pk_user_id}>
                        ...
                        <TableCell align="center">
                          <Typography
                            ...
                            color="primary"
                          >
                            {formatDate(row.last_access_at)}
                          </Typography>
                        </TableCell>
                        <TableCell align="center">
                          <StylizedChip
                            label={STATUS[row.is_active]?.label}
                            color={STATUS[row.is_active]?.color}
                            sx={{ width: '100%' }}
                          />
                        </TableCell>
                        <TableCell align="center">
                          <MenuMoreVert
                            options={[
                              {
                                label: 'Editar',
                                onClick: (e) => handleEdit(e, row.pk_user_id),
                              },
                              {
                                label: Boolean(parseInt(row.is_active))
                                  ? 'Desactivar'
                                  : 'Activar',
                                onClick: (e) =>
                                  handleStatus(
                                    e,
                                    row.pk_user_id,
                                    Boolean(parseInt(row.is_active))
                                  ),
                                title: !Boolean(parseInt(row.is_active))
                                  ? ''
                                  : 'Se liberará además la vacante asociada al usuario.',
                              },
                            ]}
                          />
                        </TableCell>
