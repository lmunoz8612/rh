        ...
        <form onSubmit={handleSubmit}>
          <Grid size={isSmallScreen ? 12 : 6} className="mt-2">
            <FormField
              ...
              error={error && !formData.policy ? true : false}
            />
          </Grid>
          <Grid size={isSmallScreen ? 12 : 6} className="mt-2">
            <FormField
              name="nom_iso"
              label={'*Nomenclatura ISO'}
              value={formData.nom_iso || ''}
              onChange={handleChange}
              error={error && !formData.nom_iso ? true : false}
            />
          </Grid>
          <Grid size={isSmallScreen ? 12 : 6} className="mt-2">
            <Catalog
              name="fk_job_position_type_id"
              apiEndpoint={'catalog/job_position/type/?available=1'}
              label={'*Alcance'}
              value={formData.fk_job_position_type_id || ''}
              onChange={handleChange}
              error={error && !formData.fk_job_position_type_id ? true : false}
            />
          </Grid>
          ...
          <Grid size={12} className="mt-2">
            ...
            >
              <Button
                type="button"
                variant="outlined"
                onClick={() => navigate('/politicas-empresa')}
