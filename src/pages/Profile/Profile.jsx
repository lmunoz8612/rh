  ...
  const handleSubmit = React.useCallback(
    async (e) => {
      ...
      try {
        ...
        const { ok, message } = await api.put(
    ...
    <GridLayout columnSpacing={0}>
      <Grid size={12}>
        ...
        <Grid container spacing={2}>
          ...
          <Grid
            size={isMediumScreen ? 12 : 5}
            sx={{ mt: isMediumScreen ? 1 : '' }}
          >
            ...
            <FormField
              ...
              error={formError.work_phone}
            />
            <FormField
              label="*Area"
              value={user.job_position_area || ''}
              sx={{ mt: 2 }}
              disabled
            />
            <FormField
              label="*Oficina"
              value={user.job_position_office || ''}
              sx={{ mt: 2 }}
              disabled
            />
          </Grid>
          <Grid size={isMediumScreen ? 12 : 5}>
            ...
            <FormField
              label="*Departamento"
              value={user.job_position_department || ''}
              sx={{ mt: 2 }}
              disabled
            />
            <FormField
              ...
              type="date"
              value={user.date_of_hire ? user.date_of_hire.split(' ')[0] : ''}
              sx={{ mt: 2 }}
              disabled
            />
          </Grid>
          ...
          <Grid size={isMediumScreen ? 12 : 5}>
            ...
            <FormField
              name="cel_phone"
              label="*Télefono personal"
              value={formData.cel_phone || ''}
              sx={{ mt: 2 }}
              onChange={handleChange}
              slotProps={{ htmlInput: { maxLength: 10 } }}
            />
          ...
          <Grid size={isMediumScreen ? 12 : 5}>
            ...
            <FormField
              ...
              sx={{ mt: 2 }}
              onChange={handleChange}
              error={formError.personal_email}
            />
            <FormField
              name="curp"
              label="*CURP"
            ...
            <FormField
              ...
              sx={{ mt: 2 }}
              onChange={handleChange}
              error={formError.emergency_name}
            />
            <FormField
          ...
          >
            <Box marginTop="auto">
              <StyledButton
                ...
                className={isMediumScreen ? 'mt-1' : 'mr-1'}
