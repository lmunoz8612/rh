...
const PasswordRecovery = () => {
  ...
  const handleSubmit = React.useCallback(
    async (e) => {
      ...
      try {
        setLoading(true);
        const { ok, message } = await api.post('login/password_recovery', {
          username: username,
        });
    ...
    <Container maxWidth="xs">
      <Box sx={classes.container} className="pd-3">
        ...
        <Typography
          ...
          color="text.primary"
        >
          Escribe el usuario del cuál quiere recuperar su contraseña.
          <br />
          Te llegará una notificación al correo asociado a la cuenta para
          continuar.
        </Typography>
        <form onSubmit={(e) => handleSubmit(e)} style={classes.form}>
          <FormField
            ...
            helperText={
              notificationProps.severity === 'error'
