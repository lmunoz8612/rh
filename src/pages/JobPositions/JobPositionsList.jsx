    ...
    <GridLayout pagination={true}>
      <Grid size={12} height="auto">
        <Typography variant="h6" fontWeight="bold" color="primary" mb={2}>
          {role <= ROLES.ADMIN ? 'ADMINISTRACIÓN DE VACANTES' : 'VACANTES'}
        </Typography>
        <SearchInput
          data={data}
          filters={{
                      ...
                      <TableRow key={row.pk_job_position_id}>
                        <TableCell align="center">
                          <Typography
                            ...
                            color="primary"
                          >
                            VC-#{padWithZeros(row.pk_job_position_id, 5)}
                          </Typography>
                        </TableCell>
                        <TableCell align="center">
                          <Typography
                        ...
                        <TableCell align="center">
                          {[ROLES.SUPER_ADMIN, ROLES.ADMIN].includes(role) ? (
                            <StylizedChip
                              label={row.job_position_admin_status}
                              color={
                                ADMIN_STATUS_COLOR[
                                  row.fk_job_position_admin_status_id
                                ]
                              }
                              sx={{
                                bgcolor:
                                  row.fk_job_position_admin_status_id === 5
                                    ? 'gray'
                                    : '',
                              }}
                            />
                            ...
                            <StylizedChip
                              label={row.job_position_status}
                              color={
                                STATUS_COLOR[row.fk_job_position_status_id]
                              }
                            />
                          )}
                        </TableCell>
                                ...
                                ? [
                                    {
                                      label: 'Editar',
                                      onClick: (e) =>
                                        handleEdit(e, row.pk_job_position_id),
                                    },
                                    {
                                      label: 'Postularme a vacante',
                                      onClick: (e) => 1,
                                      disabled: true,
                                    },
                                    {
