...
const JobPositionDepartmentCatalog = () => {
  ...
  const handleStatus = React.useCallback(async (e, rowIdx, id, status) => {
    ...
    try {
      ...
      const { ok } = await api.put('catalog/job_position/department/status', {
        id,
        status: newStatus,
      });
      if (ok) {
                  ...
                  {data.map((row, index) => (
                    <TableRow key={'tr_' + index}>
                      <TableCell align="center">
                        ...
                        >
                          DPT-#
                          {padWithZeros(row.pk_job_position_department_id, 4)}
                        </Typography>
                      </TableCell>
                      <TableCell align="center">
                        <Typography
                      ...
                      <TableCell align="center">
                        <Typography
                          ...
                          color="primary"
                        >
                          {row.job_position_department_short}
                        </Typography>
                      </TableCell>
                      <TableCell align="center">
                        <Typography
                          ...
                          options={[
                            {
                              ...
                              onClick: (e) =>
                                handleEditItem(
                                  e,
                                  row.pk_job_position_department_id
                                ),
                            },
                            {
