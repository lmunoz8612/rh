...
const JobPositionAreaCatalog = () => {
  ...
  const handleStatus = React.useCallback(async (e, rowIdx, id, status) => {
    ...
    try {
      ...
      const { ok } = await api.put('catalog/job_position/area/status', {
        id,
        status: newStatus,
      });
      if (ok) {
                    ...
                    <TableRow key={'tr_' + index}>
                      <TableCell align="center">
                        <Typography
                          ...
                          color="primary"
                        >
                          AR-#{padWithZeros(row.pk_job_position_area_id, 4)}
                        </Typography>
                      </TableCell>
                      <TableCell align="center">
                        <Typography
                          ...
                          options={[
                            {
                              label: 'Editar',
                              onClick: (e) =>
                                handleEditItem(e, row.pk_job_position_area_id),
                            },
                            {
