...
const JobPositionTypeCatalog = () => {
  ...
  const handleStatus = React.useCallback(async (e, rowIdx, id, status) => {
    ...
    try {
      ...
      const { ok } = await api.put('catalog/job_position/type/status', {
        id,
        status: newStatus,
      });
      if (ok) {
                    ...
                    <TableRow key={'tr_' + index}>
                      <TableCell align="center">
                        <Typography
                          ...
                          color="primary"
                        >
                          TPV-#{padWithZeros(row.pk_job_position_type_id, 2)}
                        </Typography>
                      </TableCell>
                      <TableCell align="center">
                        <Typography
                      ...
                      <TableCell align="center">
                        <Typography
                          ...
                          fontWeight="bold"
                          color={
                            row.created_by === '0' ? 'textSecondary' : 'primary'
                          }
                        >
                          {row.created_by === '0'
                            ? 'PLATAFORMA'
                          ...
                          options={[
                            {
                              label: 'Editar',
                              onClick: (e) =>
                                handleEditItem(e, row.pk_job_position_type_id),
                            },
                            {
