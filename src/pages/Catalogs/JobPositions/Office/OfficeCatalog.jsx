...
const JobPositionOfficeCatalog = () => {
  ...
  const handleStatus = React.useCallback(async (e, rowIdx, id, status) => {
    ...
    try {
      ...
      const { ok } = await api.put('catalog/job_position/office/status', {
        id,
        status: newStatus,
      });
      if (ok) {
                    ...
                    <TableRow key={'tr_' + index}>
                      <TableCell align="center">
                        <Typography
                          ...
                          color="primary"
                        >
                          OFC-#{padWithZeros(row.pk_job_position_office_id, 3)}
                        </Typography>
                      </TableCell>
                      <TableCell align="center">
                        <Typography
                      ...
                      <TableCell align="center">
                        <Typography
                          ...
                          color="primary"
                        >
                          {row.job_position_office_address}
                        </Typography>
                      </TableCell>
                      <TableCell align="center">
                        <Typography
