  ...
  const handleSubmit = React.useCallback(
    async (e) => {
      ...
      if (
        ...
        handleNotification(
          'error',
          'Ingresar un nombre de Oficina, Nombre Corto y Dirección válida.'
        );
        return;
      }
        ...
        <form onSubmit={handleSubmit}>
          ...
          <Grid size={isSmallScreen ? 12 : 6} className="mt-2">
            ...
            >
              <Button
                variant="outlined"
                onClick={() => navigate('/catalogos/vacantes/oficina')}
