...
const UserRelationshipsCatalog = () => {
  ...
  const handleStatus = React.useCallback(async (e, rowIdx, id, status) => {
    ...
    try {
      ...
      const { ok } = await api.put('catalog/user/relationships/status', {
        id,
        status: newStatus,
      });
      if (ok) {
                    ...
                    <TableRow key={'tr_' + index}>
                      <TableCell align="center">
                        <Typography
                          ...
                          color="primary"
                        >
                          PRT-#{padWithZeros(row.pk_relationship_id, 3)}
                        </Typography>
                      </TableCell>
                      <TableCell align="center">
                        <Typography
                          ...
                          options={[
                            {
                              label: 'Editar',
                              onClick: (e) =>
                                handleEditItem(e, row.pk_relationship_id),
                            },
                            {
