...
const UserNationalitiesCatalog = () => {
  ...
  const handleStatus = React.useCallback(async (e, rowIdx, id, status) => {
    ...
    try {
      ...
      const { ok } = await api.put('catalog/user/nationalities/status', {
        id,
        status: newStatus,
      });
      if (ok) {
                    ...
                    <TableRow key={'tr_' + index}>
                      <TableCell align="center">
                        <Typography
                          ...
                          color="primary"
                        >
                          NC-#{padWithZeros(row.pk_nationality_id, 4)}
                        </Typography>
                      </TableCell>
                      <TableCell align="center">
                        <Typography
                          ...
                          options={[
                            {
                              label: 'Editar',
                              onClick: (e) =>
                                handleEditItem(e, row.pk_nationality_id),
                            },
                            {
