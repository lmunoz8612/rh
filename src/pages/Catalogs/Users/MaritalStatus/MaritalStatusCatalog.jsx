...
const UserMaritalStatusCatalog = () => {
  ...
  const handleStatus = React.useCallback(async (e, rowIdx, id, status) => {
    ...
    try {
      ...
      const { ok } = await api.put('catalog/user/marital_status/status', {
        id,
        status: newStatus,
      });
      if (ok) {
                    ...
                    <TableRow key={'tr_' + index}>
                      <TableCell align="center">
                        <Typography
                          ...
                          color="primary"
                        >
                          MS-#{padWithZeros(row.pk_marital_status_id, 4)}
                        </Typography>
                      </TableCell>
                      <TableCell align="center">
                        <Typography
                          ...
                          options={[
                            {
                              label: 'Editar',
                              onClick: (e) =>
                                handleEditItem(e, row.pk_marital_status_id),
                            },
                            {
